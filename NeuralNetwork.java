 ...
 * This framework supports only one hidden layer and the activation 
 * function is sigmoid.

 * In this example there are two inputs neurons, 
 * four neurons in hidden layers and one neuron in output layer. 
